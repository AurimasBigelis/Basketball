<html>
    ...
    <?php
        ...
        if (!file_exists("Dvitaskiai/Dvitaskiai2.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Dvitaskiai/Dvitaskiai2.txt", "r+");
            $n = file("Dvitaskiai/Dvitaskiai2.txt");
            fclose($fp);
      ...
      echo "</div>";
        ...
        if (!file_exists("Tritaskiai/Tritaskiai2.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Tritaskiai/Tritaskiai2.txt", "r+");
            $n = file("Tritaskiai/Tritaskiai2.txt");
            fclose($fp);
