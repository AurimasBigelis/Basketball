<html>
    ...
    <?php
        ...
        if (!file_exists("Dvitaskiai/Dvitaskiai5.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Dvitaskiai/Dvitaskiai5.txt", "r+");
            $n = file("Dvitaskiai/Dvitaskiai5.txt");
            fclose($fp);
      ...
      echo "</div>";
        ...
        if (!file_exists("Tritaskiai/Tritaskiai5.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Tritaskiai/Tritaskiai5.txt", "r+");
            $n = file("Tritaskiai/Tritaskiai5.txt");
            fclose($fp);
