<html>
    ...
    <?php
        ...
        if (!file_exists("Dvitaskiai/Dvitaskiai3.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Dvitaskiai/Dvitaskiai3.txt", "r+");
            $n = file("Dvitaskiai/Dvitaskiai3.txt");
            fclose($fp);
      ...
      echo "</div>";
        ...
        if (!file_exists("Tritaskiai/Tritaskiai3.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Tritaskiai/Tritaskiai3.txt", "r+");
            $n = file("Tritaskiai/Tritaskiai3.txt");
            fclose($fp);
