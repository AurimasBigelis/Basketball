<html>
    ...
    <?php
        ...
        if (!file_exists("Dvitaskiai/Dvitaskiai1.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Dvitaskiai/Dvitaskiai1.txt", "r+");
            $n = file("Dvitaskiai/Dvitaskiai1.txt");
            fclose($fp);
      ...
      echo "</div>";
        ...
        if (!file_exists("Tritaskiai/Tritaskiai1.txt")) {
            exit ("No messages!");
        } else {
            $fp = fopen ("Tritaskiai/Tritaskiai1.txt", "r+");
            $n = file("Tritaskiai/Tritaskiai1.txt");
            fclose($fp);
